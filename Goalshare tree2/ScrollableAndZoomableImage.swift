//
//  ScrollableAndZoomableImage.swift
//  Goalshare tree2
//
...
struct ScrollableAndZoomableImage: View {
    var body: some View {
        GeometryReader { proxy in
            let image = UIImage(named: "fedW")
            Image("fedW")
                .clipShape(Rectangle())
                .modifier(ImageModifier(contentSize: CGSize(width: image!.size.width, height: image!.size.height)))
